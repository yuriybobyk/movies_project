...
const RowElement:FC<IProps> = ({movie, onCardClick}) => {
    ...
    return (
        <div className="relative h-78 min-w-[180px] cursor-pointer transition duration-200 ease-out md:h-74 md:min-w-[240px] md:hover:scale-105" onClick={handleCardClick}>
