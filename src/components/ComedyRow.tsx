...
const ComedyRow = ({title}: IProps) => {
    ...
    const {comedyMovies, isModalOpen, trailer} = useAppSelector(state => state.movieReducer)
        ...
        <div className="h-80 space-y-0.5 md:space-y-2">
            ...
            <div className="group relative md:-ml-2">
                ...
                <div ref={rowRef}
                    ...
                    {comedyMovies && comedyMovies.map(comedyMovie => <RowElement onCardClick={handleMovieCardClick}
                                                                                 movie={comedyMovie}
                                                                                 key={comedyMovie.id}/>)}
                </div>
                <ChevronRightIcon
